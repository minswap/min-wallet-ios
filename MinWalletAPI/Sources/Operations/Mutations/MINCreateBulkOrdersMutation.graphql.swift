...
public class MINCreateBulkOrdersMutation: GraphQLMutation {
  public static let operationName: String = "MINCreateBulkOrders"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation MINCreateBulkOrders($input: InputCreateBulkOrders!) { createBulkOrders(input: $input) }"#
    ))
