...
public class MINCancelBulkOrdersMutation: GraphQLMutation {
  public static let operationName: String = "MINCancelBulkOrdersMutation"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation MINCancelBulkOrdersMutation($input: InputCancelBulkOrders!) { cancelBulkOrders(input: $input) }"#
    ))
