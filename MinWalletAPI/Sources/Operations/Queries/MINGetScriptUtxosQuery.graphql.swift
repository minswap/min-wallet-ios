...
public class MINGetScriptUtxosQuery: GraphQLQuery {
  public static let operationName: String = "MINGetScriptUtxos"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query MINGetScriptUtxos($txIns: [String!]!) { getScriptUtxos(txIns: $txIns) { __typename rawDatum rawUtxo } }"#
    ))
