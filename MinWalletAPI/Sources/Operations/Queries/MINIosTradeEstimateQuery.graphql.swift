...
public class MINIosTradeEstimateQuery: GraphQLQuery {
  public static let operationName: String = "MINIosTradeEstimateQuery"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query MINIosTradeEstimateQuery($input: IosTradeEstimateInput!) { iosTradeEstimate(input: $input) { __typename estimateAmount inputIndex lpAssets { __typename currencySymbol tokenName } lpFee outputIndex path { __typename currencySymbol tokenName } priceImpact type direction } }"#
    ))
