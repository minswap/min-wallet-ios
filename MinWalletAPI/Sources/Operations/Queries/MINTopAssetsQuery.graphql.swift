...
public class MINTopAssetsQuery: GraphQLQuery {
  public static let operationName: String = "MINTopAssetsQuery"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query MINTopAssetsQuery($input: TopAssetsInput) { topAssets(input: $input) { __typename searchAfter topAssets { __typename price asset { __typename currencySymbol metadata { __typename isVerified decimals ticker name description } tokenName details { __typename categories project socialLinks { __typename coinGecko coinMarketCap discord telegram twitter website } } } priceChange24h } } }"#
    ))
