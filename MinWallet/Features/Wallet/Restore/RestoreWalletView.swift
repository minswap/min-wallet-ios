    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack(alignment: .top, spacing: .xl) {
                ...
                .overlay(RoundedRectangle(cornerRadius: 16).stroke(restoreType == .seedPhrase ? .colorInteractiveToneHighlight : .colorBorderPrimaryTer, lineWidth: 2))
                .contentShape(.rect)
                .onTapGesture {
                ...
                .frame(maxHeight: .infinity)
                .padding(16)
                .overlay(RoundedRectangle(cornerRadius: 16).stroke(restoreType == .importJson ? .colorInteractiveToneHighlight : .colorBorderPrimaryTer, lineWidth: 2))
                .contentShape(.rect)
                .onTapGesture {
