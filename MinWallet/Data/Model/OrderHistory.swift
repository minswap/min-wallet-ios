...
extension OrderHistoryQuery.Data.Orders.WrapOrder {
    ...
    var overSlippageWarning: AttributedString? {
        ...
        case "DepositOverSlippageDetail":
            ...
            attr = [
                AttributedString("Your attempt to deposit \(inputTicker) and \(inputBTicker) to receive LP tokens could not be completed because the amount of LP tokens generated by the deposit, based on current rates ").build(),
